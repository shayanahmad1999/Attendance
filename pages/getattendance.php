   ...
   ?> 
        ...
        <script>
            $(document).ready(function() {
                ...
                // $('#pressentActiveSts').attr('checked',true)
                // $('#pressentActiveSts').prop('checked', true);
                
            });

            // function test()
            // {
            //     document.getElementById("pressentActiveSts").checked = true;
            // }
            // validateGroup();
            // function validateGroup() 
            // {                                                           //id="pressentActiveSts"
            //   var elements=  validateGroup(document.getElementsByName("attendance"))
