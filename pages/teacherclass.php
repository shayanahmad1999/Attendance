                        ...
                        <div class="col-lg-12">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <form role="form" action="teacherclass/insertion.php" method="post" enctype="multipart/form-data">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <select name="teacher" class="form-control">
                                                            ...
                                                            <?php
                                                                ...
                                                                {
                                                            ?>
                                                            <option value="<?php echo $show['tId']; ?>"><?php echo $show['tName']; ?></option>
                                                            <?php } ?>
                                                        </select>
                                                    </div>
                                                ...
                                                <input type="hidden" name="teacherclass" value="insertion">
                                            </form>
                                        </div>
                                                    
                                        <?php
                                            $query = "select * from tblclassassignteacher
                                            inner join tblclass on tblclass.clId = tblclassassignteacher.clId
                                            inner join tblteachers on tblteachers.tId = tblclassassignteacher.tId";
                                            $go = mysqli_query($connect,$query);
                                        ?>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                            ...
                                            <tbody>
                                               ...
                                               <td>
                                                  <a href="teacherclassEdit.php?tclid=<?php echo $record['ctId']; ?>"><button type="button" class="btn btn-primary">
                                                  <i class="fa fa-edit"></i></button></a>
                                                  <a href="teacherclass/delete.php?tclid=<?php echo $record['ctId']; ?>" onclick="return confirm('are you sure')"><button class="btn btn-danger"><i class="fa fa-trash"></i></button></a>
                                                </td>
